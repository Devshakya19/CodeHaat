#!/bin/bash
# =============================================================================
# KodeDock - Interactive Setup (CLI Edition)
# =============================================================================
set -e
...
# ── Boot Animation ──
clear
echo -e "${CYAN}Initializing KodeDock Core Subsystems${NC}"
printf "Starting"
for i in {1..4}; do
    printf "."
    sleep 0.4
...
if [ -f .env ]; then
    ...
    echo -e "${CYAN}Welcome to KodeDock! We need to configure a few API keys.${NC}\n"
...
cat > .env << EOF
# KodeDock Environment - Generated by Setup CLI
...
EOF
echo -e "${NC}"
echo -e "  ✅ KodeDock is now successfully running!\n"
