...
export default async function ShopLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-accent/20 selection:text-foreground">
      ...
      {/* Premium Footer */}
      <footer className="border-t border-border/60 bg-background mt-20 pt-16 pb-8">
        <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <Code2 className="w-6 h-6 text-accent" />
                <span className="text-[18px] font-black tracking-tight text-foreground">KodeDock</span>
              </div>
              <p className="text-[13px] font-medium text-muted-foreground leading-relaxed mb-6 max-w-xs">
