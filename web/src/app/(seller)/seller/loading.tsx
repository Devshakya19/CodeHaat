    ...
    <div className="w-full font-sans animate-pulse">
      ...
      <div className="mb-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div>
          ...
          <div className="h-4 bg-slate-100 rounded-lg w-96 max-w-full" />
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mb-8">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="rounded-[26px] bg-white p-1.5 ring-1 ring-slate-200/60 shadow-xs"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-[28px] bg-white p-2 ring-1 ring-slate-200/60 shadow-xs">
