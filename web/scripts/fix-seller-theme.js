  ...
  fs.readdirSync(dir).forEach(file => {
    ...
    if (fs.statSync(fullPath).isDirectory()) {
      ...
      for (const [key, value] of Object.entries(replacements)) {
        // We handle exact class replacements. Using regex with word boundaries but escaping brackets for shadow classes
...
walkDir('./src/app/(seller)');
walkDir('./src/components/settings');
